...
})({"ad9BD":[function(require,module,exports) {
...
const fraesenUrl = new URL(require("e66e2c3d05ace832")).href;
...
gLTFLoader.load(fraesenUrl, (gltf)=>{
    ...
    model.traverse((child)=>{
        if (child.isMesh && child.material.map) child.material.map.encoding = THREE.sRGBEncoding;
    });
    scene.add(model);
...
const animate = ()=>{
    ...
    if (mixer && currentSection === 1) mixer.update(deltaTime);
    const hdrUrls = [
        "px.hdr",
        "nx.hdr",
        "py.hdr",
    ...
    hdrCubeMap = new HDRCubeTextureLoader().setPath("../assets/CubeHdr/").load(hdrUrls, function() {
...
},{"e66e2c3d05ace832":"i072R"}],"i072R":[function(require,module,exports) {
module.exports = require("3c863eee1b94bcdc").getBundleURL("9ULLa") + "7.4702d1d3.glb" + "?" + Date.now();

},{"3c863eee1b94bcdc":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
},{}]},["ad9BD","fgDBQ"], "fgDBQ", "parcelRequire2fa5")
